// 纯JavaScript noop函数，替代lodash/noop
const noop = () => {};
import type { Language } from "@comet-swap/localization";
  ...
  const { asFragment } = renderWithProvider(
    <BrowserRouter>
      <Menu
        ...
        buyCometLabel="Buy COMET"
        buyCometLink="https://cometswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82&chainId=56"
      >
        body
      </Menu>
    </BrowserRouter>
