...
export const Box: React.FC<React.PropsWithChildren> = () => {
  return (
    <div>
      <BoxComponent as="p">
        Contains background, border, layout, position, and space using{" "}
        <Link href="#" target="_blank">
          Stellar&lsquo;s styling system
        </Link>
      </BoxComponent>
    </div>
  );
...
export const Flex: React.FC<React.PropsWithChildren> = () => {
  return (
    <div>
      <Text>Based on the Box component using Stellar UI. You can apply any flexbox properties on the Flex component.</Text>
      <Link href="#" target="_blank">
