...
export const TokenImages: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://cometswap.finance/images/tokens/${token.address[56]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://cometswap.finance/images/tokens/${token.address[56]}.png`;
        const secondarySrc = `https://cometswap.finance/images/tokens/${tokens[randomTokenIndex].address[56]}.png`;
