...
import { getApy } from "@comet-swap/utils/compoundApyHelpers";
import BigNumber from "bignumber.js";
import { useMemo, useState } from "react";
import { styled } from "../../styled-components";

import { BIG_ONE_HUNDRED } from "@comet-swap/utils/bigNumber";
...
export const Footer = styled(Flex)`
  width: 100%;
  background: ${({ theme }: { theme: any }) => theme.colors.dropdown};
`;
