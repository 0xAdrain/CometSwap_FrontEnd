...
const DropDownListContainer = styled.div`
  ...
  z-index: ${({ theme }: { theme: any }) => theme.zIndices.dropdown};
...
const DropDownContainer = styled(Box)<{ isOpen: boolean }>`
  ...
  ${(props) =>
    ...
    css`
      ${DropDownHeader} {
        border-bottom: 1px solid ${({ theme }: { theme: any }) => theme.colors.inputSecondary};
        box-shadow: ${({ theme }: { theme: any }) => theme.tooltip.boxShadow};
