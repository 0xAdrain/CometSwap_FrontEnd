...
const SubMenuItems: React.FC<React.PropsWithChildren<SubMenuItemsProps>> = ({
  ...
  return (
    <AtomBox display={["none", null, "block"]} asChild>
      <SubMenuItemWrapper $isMobileOnly={isMobileOnly} {...props}>
        <AtomBox display={["block", null, null, null, "none"]} asChild>
          <LeftMaskLayer
            ref={chevronLeftRef}
                ...
                <StyledSubMenuItemWrapper key={label} mr="20px">
                  ...
                  >
                    <FlexGap gap="10px" alignItems="center">
                      ...
                      {status && (
                        <LinkStatus textTransform="uppercase" color={status.color as any} fontSize="14px">
                          {status.text}
                        </LinkStatus>
                      )}
                    </FlexGap>
                    {isExternalLink && (
                      <Box display={["none", null, null, null, "flex"]} style={{ alignItems: "center" }} ml="4px">
