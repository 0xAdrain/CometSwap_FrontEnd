...
export const Th = styled(Td).attrs({ as: "th" })<TypographyProps>`
  ...
  white-space: nowrap;
  background-color: ${({ theme }: { theme: any }) => theme.colors.backgroundAlt}; /* CometSwap: 表头背景色 */
  border-bottom: 2px solid ${({ theme }: { theme: any }) => theme.colors.cardBorder}; /* CometSwap: 更明显的表头分隔线 */
