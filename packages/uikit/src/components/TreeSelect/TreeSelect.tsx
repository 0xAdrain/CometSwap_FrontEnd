...
const SelectContainer = styled.div`
  ...
  .p-checkbox {
    ...
    .p-checkbox-box {
      ...
      align-items: center;
      border: 2px solid ${({ theme }: { theme: any }) => theme.colors.inputSecondary};
      background: ${({ theme }: { theme: any }) => theme.card.background};
      width: 24px;
      height: 24px;
      border-radius: 8px;
    ...
    &.p-highlight {
      .p-checkbox-box {
        ...
        background: ${({ theme }: { theme: any }) => theme.colors.success};
      }
    }
  }
  .p-checkbox-input {
