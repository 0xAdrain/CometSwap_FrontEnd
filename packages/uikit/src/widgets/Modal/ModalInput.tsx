...
import { displayBalance } from "@comet-swap/utils/displayBalance";
import { trimTrailZero } from "@comet-swap/utils/trimTrailZero";
...
const StyledTokenInput = styled.div<InputProps>`
  ...
  border-radius: 16px;
  box-shadow: ${({ theme, isWarning  }: { theme: any, isWarning: any }) => (isWarning ? theme.colors.warning : theme.shadows.inset)};
...
const StyledInput = styled(Input)`
  ...
  ${({ theme }: { theme: any }) => theme.mediaQueries.sm} {
    width: auto;
  }
`;
