...
const MotionModal: React.FC<React.PropsWithChildren<ModalProps>> = ({
  ...
  return (
    ...
    >
      <ModalHeader
        {...(headerBackground && { backgroundColor: getThemeValue(theme, `colors.${headerBackground}`, headerBackground) })}
        style={{ padding: headerPadding }}
        {...(headerBorderColor && { borderColor: headerBorderColor })}
      >
        <ModalTitle>
