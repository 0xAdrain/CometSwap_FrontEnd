// Note: Temporarily removed localization dependency to allow frontend startup
// TODO: Implement getLanguageCodeFromLS in @comet-swap/localization
// import { getLanguageCodeFromLS } from '@comet-swap/localization'

const getLanguageCodeFromLS = (): string => 'en' // Fallback
